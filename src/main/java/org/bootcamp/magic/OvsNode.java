...
public final class OvsNode {
    ...
    private final OvsNodeState state;

    public static final Comparator<OvsNode> CORDVTN_NODE_COMPARATOR =
     ...
     */
    public OvsNode(String hostname, NetworkAddress hostMgmtIp, NetworkAddress localMgmtIp,
                       NetworkAddress dpIp, TpPort ovsdbPort, SshAccessInfo sshInfo,
                       DeviceId bridgeId, String dpIntf, OvsNodeState state) {
     ...
     * @return cordvtn node
     */
    public static OvsNode getUpdatedNode(OvsNode node, OvsNodeState state) {
        return new OvsNode(node.hostname,
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OvsNode) {
            OvsNode that = (OvsNode) obj;
